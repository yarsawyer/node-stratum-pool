...
var pool = module.exports = function pool(options, authorizeFn) {
    ...
    function GetFirstJob(finishedCallback) {
        ...
        GetBlockTemplate(function (error, result) {
            ...
            Object.keys(options.ports).forEach(function (port) {
                ...
                if (networkDiffAdjusted < portDiff/65536)
                    portWarnings.push('port ' + port + ' w/ diff ' + portDiff/65536);
            });
    ...
    function StartStratumServer(finishedCallback) {
        _this.stratumServer = new stratum.Server(options, authorizeFn, _this);
        ...
        _this.stratumServer.on('started', function () {
            ...
            client.on('difficultyChanged', function (diff) {
                ...
                if (params.fixed_diff && params.fixed_diff > options.ports[options.socket.localPort].minDiff && params.fixed_diff < options.ports[options.socket.localPort].maxDiff)
                {
                    ...
                    this.sendDifficulty(options.ports[options.socket.localPort].diff);
                } else {
