    ...
    function StartStratumServer(finishedCallback) {
        ...
        _this.stratumServer.on('started', function () {
            ...
            client.on('difficultyChanged', function (diff) {
                ...
                console.log(params.fixed_diff, options.ports[client.socket.localPort].minDiff, options.ports[client.socket.localPort].maxDiff)
                if (params.fixed_diff && params.fixed_diff > options.ports[client.socket.localPort].minDiff && params.fixed_diff < options.ports[client.socket.localPort].maxDiff)
                {
